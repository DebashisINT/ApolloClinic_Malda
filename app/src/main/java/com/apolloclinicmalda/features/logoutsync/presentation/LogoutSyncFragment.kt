package com.apolloclinicmalda.features.logoutsync.presentation
...
import com.apolloclinicmalda.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.apolloclinicmalda.features.billing.api.AddBillingRepoProvider
import com.apolloclinicmalda.features.billing.model.AddBillingInputParamsModel
...
import com.apolloclinicmalda.features.dashboard.presentation.ReasonDialog
...
import com.apolloclinicmalda.features.document.model.AddEditDocumentInputParams
import com.apolloclinicmalda.features.document.model.DocumentAttachmentModel
...
import com.apolloclinicmalda.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.apolloclinicmalda.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.apolloclinicmalda.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.apolloclinicmalda.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.apolloclinicmalda.features.orderhistory.model.*
...
import com.apolloclinicmalda.features.quotation.model.AddQuotInputModel
import com.apolloclinicmalda.features.shopdetail.presentation.api.EditShopRepoProvider
import com.apolloclinicmalda.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.apolloclinicmalda.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.apolloclinicmalda.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.apolloclinicmalda.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.apolloclinicmalda.features.timesheet.model.AddTimeSheetInputModel
...
import com.apolloclinicmalda.MonitorService
...
import com.apolloclinicmalda.features.addshop.presentation.ShopExtraContactReq
...
import com.apolloclinicmalda.features.login.model.GetConcurrentUserResponse
import com.apolloclinicmalda.features.performance.model.Gps_status_list
import com.apolloclinicmalda.features.performance.model.UpdateGpsInputListParamsModel
import com.apolloclinicmalda.features.returnsOrder.ReturnProductList
import com.apolloclinicmalda.features.returnsOrder.ReturnRequest
import com.apolloclinicmalda.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicmaldalogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicmaldalogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xapolloclinicmaldalogsample/log.zip").path);
