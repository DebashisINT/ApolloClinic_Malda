package com.apolloclinicmalda.features.addshop.presentation
...
import com.apolloclinicmalda.features.NewQuotation.AddQuotFormFragment
...
import com.apolloclinicmalda.features.dashboard.presentation.ShopVerificationDialog
import com.apolloclinicmalda.features.dashboard.presentation.VisitRemarksTypeAdapter
...
import com.apolloclinicmalda.features.login.model.GetQtsAnsSubmitDtlsResponseModel
...
//                                (mContext as DashboardActivity).showSnackMessage("SUCCESS")
                                    ...
                                    progress_wheel.stopSpinning()
                                    XLog.d("AddShop : " + ", SHOP: " + addShop.shop_name + " else , RESPONSE: ${addShopResult.status} " + result.message)
                                    (mContext as DashboardActivity).showSnackMessage(getString(R.string.shop_added_successfully))
                                    voiceAttendanceMsg(getString(R.string.shop_added_successfully))
//                                (mContext as DashboardActivity).showSnackMessage(getString(R.string.shop_added_successfully))
                                    (mContext as DashboardActivity).onBackPressed()
